...
class CutsContainer
{
 ...
 public:
  ...
  void SetCutCosineTopoDown(float value){cut_cosine_topo_down_ = value; is_apply_cut_cosine_topo_down_ = true;};
  void SetCutCosineTopoUp(float value){cut_cosine_topo_up_ = value; is_apply_cut_cosine_topo_up_ = true;};
  ...
  void SetCutChi2PrimThird(float value){cut_chi2_prim_third_ = value; is_apply_cut_chi2_prim_third_ = true;};
  void SetCutDistanceThird(float value){cut_distance_third_ = value; is_apply_cut_distance_third_ = true;};
  void SetCutCosineDaughterThird(float value){cut_cosine_daughter_third_ = value; is_apply_cut_cosine_daughter_third_ = true;};
  void SetCutChi2GeoThree(float value){cut_chi2_geo_three_ = value; is_apply_cut_chi2_geo_three_ = true;};
  void SetCutLThreeUp(float value){cut_l_three_up_ = value; is_apply_cut_l_three_up_ = true;};
  void SetCutLThreeDown(float value){cut_l_three_down_ = value; is_apply_cut_l_three_down_ = true;};
  void SetCutLThreedL(float value){cut_ldl_three_ = value; is_apply_cut_ldl_three_ = true;};
  void SetCutIsFromPVThree(int value){cut_is_from_pv_three_ = value; is_apply_cut_is_from_pv_three_ = true;};
  void SetCutCosineTopoThreeDown(float value){cut_cosine_topo_three_down_ = value; is_apply_cut_cosine_topo_three_down_ = true;};
  void SetCutCosineTopoThreeUp(float value){cut_cosine_topo_three_up_ = value; is_apply_cut_cosine_topo_three_up_ = true;};
  void SetCutChi2TopoThree(float value){cut_chi2_topo_three_ = value; is_apply_cut_chi2_topo_three_ = true;};
 ...
 protected:
  ...
  float cut_l_three_up_{200.}; float cut_l_three_down_{5.};
  ...
  bool is_apply_cut_l_three_up_{true}; bool is_apply_cut_l_three_down_{true};
